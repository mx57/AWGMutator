...
object EndpointCatalog {
    ...
    val preconfiguredEndpoints: List<EndpointItem> = listOf(
        ...
        EndpointItem("ep_ru_bypass_4", "188.114.99.1", 500, "ALL", "Global Anycast", "🌍", "CF IPsec Port 500 (Clean)"),
        EndpointItem("ep_ru_bypass_5", "188.114.97.35", 859, "ALL", "Global Anycast", "🌍", "CF Edge Port 859 (Clean)"),
        EndpointItem("ep_ru_bypass_6", "188.114.96.60", 894, "ALL", "Global Anycast", "🌍", "CF Edge Port 894 (Clean)"),
        EndpointItem("ep_ru_bypass_7", "188.114.98.45", 878, "ALL", "Global Anycast", "🌍", "CF Edge Port 878 (Clean)"),
        EndpointItem("ep_ru_bypass_8", "188.114.99.100", 903, "ALL", "Global Anycast", "🌍", "CF Edge Port 903 (Clean)"),
        EndpointItem("ep_ru_bypass_9", "188.114.97.150", 908, "ALL", "Global Anycast", "🌍", "CF Edge Port 908 (Clean)"),
        EndpointItem("ep_ru_bypass_10", "188.114.96.200", 2408, "ALL", "Global Anycast", "🌍", "CF Edge Port 2408 (Clean)"),
        EndpointItem("ep_ru_bypass_11", "188.114.98.1", 500, "ALL", "Global Anycast", "🌍", "CF IPsec Port (Clean)"),
        EndpointItem("ep_ru_bypass_12", "188.114.99.1", 4500, "ALL", "Global Anycast", "🌍", "CF NAT-T Port (Clean)"),
